...
import co.spin.utils.printStackTrace
...
class EasySocketInterface
constructor(override var url: Url,
            override var delegate: SocketDelegate?) : WebSocketInterface {
    ...
    override var state: SocketState = SocketState.SocketClosed
